...
async function main() {
    ...
    // Open ticket
    subManager.subscribeToTopic("open-ticket-task-new-customer", new OpenTicket_1.OpenTicketExternalTask("new-ticket-received-message-new-customer"));
    // Save ticket
    ...
    // Notify IT
    subManager.subscribeToTopic("notify-it-developer-task-new-customer", new NotifyTicket_1.NotifyTicketExternalTask("new-ticket-created-message-new-customer"));
    // Close ticket
    subManager.subscribeToTopic("close-ticket-task-new-customer", new CloseTicket_1.CloseTicketExternalTask("recive-closed-ticket-message-new-customer"));
    // Notify Credentials
    subManager.subscribeToTopic("notify-credential-task-new-customer", new NotifyTicket_1.NotifyTicketExternalTask("recive-credential-message-new-customer"));
    // Notify Ticket Owner
    subManager.subscribeToTopic("notify-ticket-owner-new-customer", new NotifyTicket_1.NotifyTicketExternalTask("closed-ticket-message-new-customer"));
}
