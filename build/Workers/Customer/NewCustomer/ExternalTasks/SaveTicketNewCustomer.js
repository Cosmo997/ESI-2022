...
exports.subSubSaveTicketNewCustomer = void 0;
 ...
 */
async function subSubSaveTicketNewCustomer() {
    ...
    client.subscribe("save-ticket-new-customer", async function ({ task, taskService }) {
        ...
        console.log("\n\n");
        console.log(JSON.parse(JSON.stringify(task.variables.getAll())));
        console.log("\n\nVariables: \n");
...
exports.subSubSaveTicketNewCustomer = subSubSaveTicketNewCustomer;
